...
def color_for_model(model_name: str) -> str:
    """Return a stable color for a model or expert-labeled model name."""
...
def linestyle_for_model(model_name: str) -> str:
    """Use line style to distinguish initial/final variants without changing color."""
...
def marker_for_model(model_name: str) -> str:
    """Use a stable marker for model-level comparison curves."""
...
def category_color(value: object) -> str:
    """Return stable color for family and expert categorical annotations."""
